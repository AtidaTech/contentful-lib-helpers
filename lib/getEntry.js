 ...
 * @returns {Promise<import("contentful-management/dist/typings/entities/entry").Entry|null>} - A Promise that resolves with the entry object, or `null` if not found.
 *
 * @example
 *
 * Usage:
